...
const UserContextPronider = ({children})=>{ // it nothing but a method
    const [user, setUser] = React.useState(null)// we can simple useState() at place of React.useState()- just for that have ti import useState from react , dont want to import then use React.useState() 
    return(
